...
C_SRCS += \
../src/nfc/NxpNfcRdLib/comps/phCryptoRng/src/Sw/phCryptoRng_Sw.c 

SREC += \
HK.srec 

C_DEPS += \
./src/nfc/NxpNfcRdLib/comps/phCryptoRng/src/Sw/phCryptoRng_Sw.d 

OBJS += \
./src/nfc/NxpNfcRdLib/comps/phCryptoRng/src/Sw/phCryptoRng_Sw.o 
...
src/nfc/NxpNfcRdLib/comps/phCryptoRng/src/Sw/%.o: ../src/nfc/NxpNfcRdLib/comps/phCryptoRng/src/Sw/%.c
