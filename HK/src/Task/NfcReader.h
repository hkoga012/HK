...
enum {
    ...
    NFC_SCODE_Felica = 0x30,       //!< IDM
    NFC_SCODE_IDM = 0x31,       //!< FTSic or サーパス
    //NFC_SCODE_IDM = 0x30,       //!< IDM
    //NFC_SCODE_FTSIC = 0x32,     //!< FTSic
    //NFC_SCODE_SURPASS = 0x33,   //!< サーパス
    NFC_SCODE_MIFARE = 0x32,    //!< Mifare
...
private:
    ...
    //uint8_t GetSCode(uint8_t CardType, ENUM_SEL_FUNC_FELICA FuncFeliCa);
    uint8_t GetTargetCode(ENUM_SEL_FUNC_MIFARE FuncMifare, ENUM_SEL_FUNC_FELICA FuncFeliCa);
    //uint8_t GetTargetCode(ENUM_SEL_FUNC_FELICA FuncFeliCa);
