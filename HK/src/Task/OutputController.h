...
#ifdef WINDOWS_DEBUG
#include "../../../WinR1/SimPanel/SimPanelClient.h"
#endif
...
//!< LED定義
enum ENUM_LED{
    LED_IDX_0 = 0,       //!< LED Left
    LED_IDX_1,         //!< LED Center
    LED_IDX_2,          //!< LED Right
    LED_IDX_P,          //!< LED Frame
    LED_IDX_MAX,            //!< LED MAX
};
...
constexpr uint32_t LED_COMMAND_MAX = 25;        //!< LEDコマンド最大数 R1環境要確認
...
public:
    ...
    const DATA _ledPattern[LED_COMMAND_MAX][LED_PATTERN_MAX] = {
        ...
        */
        ...
        {{IO_GRN,40}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '1':2秒間 緑点灯
        {{IO_RED,40}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '2':2秒間 赤点灯
        {{IO_ORG,40}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '3':2秒間 橙点灯
        {{IO_GRN,60}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '4':3秒間 緑点灯
        {{IO_RED,60}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '5':3秒間 赤点灯
        {{IO_ORG,60}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '6':3秒間 橙点灯
        {{IO_GRN, 5}, {IO_OFF, 5}, {IO_GRN, 5}, {IO_OFF, 5}, {IO_GRN, 5}, {IO_OFF, 5}, {IO_GRN, 5}, {IO_OFF, 5}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '7':緑0.25秒おき2秒間点滅
        {{IO_RED, 5}, {IO_OFF, 5}, {IO_RED, 5}, {IO_OFF, 5}, {IO_RED, 5}, {IO_OFF, 5}, {IO_RED, 5}, {IO_OFF, 5}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '8':赤0.25秒おき2秒間点滅
        {{IO_ORG, 5}, {IO_OFF, 5}, {IO_ORG, 5}, {IO_OFF, 5}, {IO_ORG, 5}, {IO_OFF, 5}, {IO_ORG, 5}, {IO_OFF, 5}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< '9':橙0.25秒おき2秒間点滅
        {{IO_GRN,10}, {IO_OFF,10}, {IO_GRN,10}, {IO_OFF,10}, {IO_GRN,10}, {IO_OFF,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'A':緑0.5秒おき3秒間点滅
        {{IO_RED,10}, {IO_OFF,10}, {IO_RED,10}, {IO_OFF,10}, {IO_RED,10}, {IO_OFF,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'B':赤0.5秒おき3秒間点滅
        {{IO_ORG,10}, {IO_OFF,10}, {IO_ORG,10}, {IO_OFF,10}, {IO_ORG,10}, {IO_OFF,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'C':橙0.5秒おき3秒間点滅
        {{IO_ORG, 5}, {IO_GRN, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_END, 0}},  //!< 'D':橙→緑→橙0.25秒おき3秒間点滅
        {{IO_ORG, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_RED, 5}, {IO_END, 0}},  //!< 'E':橙→赤→橙0.25秒おき3秒間点滅
        {{IO_ORG, 5}, {IO_GRN, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_GRN, 5}, {IO_RED, 5}, {IO_ORG, 5}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'F':橙→緑→赤→橙0.25秒おき3秒間点滅
        {{IO_ORG,10}, {IO_GRN,10}, {IO_ORG,10}, {IO_GRN,10}, {IO_ORG,10}, {IO_GRN,10}, {IO_ORG,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'G':橙→緑→橙0.5秒おき3.5秒間点滅
        {{IO_ORG,10}, {IO_RED,10}, {IO_ORG,10}, {IO_RED,10}, {IO_ORG,10}, {IO_RED,10}, {IO_ORG,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'H':橙→赤→橙0.5秒おき3.5秒間点滅
        {{IO_ORG,10}, {IO_GRN,10}, {IO_RED,10}, {IO_ORG,10}, {IO_GRN,10}, {IO_RED,10}, {IO_ORG,10}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'I':橙→緑→赤→橙0.5秒おき3.5秒間点滅
        {{IO_ORG,10}, {IO_OFF, 5}, {IO_GRN,10}, {IO_OFF, 5}, {IO_RED,10}, {IO_OFF, 5}, {IO_ORG,10}, {IO_OFF, 5}, {IO_GRN,10}, {IO_OFF, 5}, {IO_RED,10}, {IO_OFF, 5}, {IO_END, 0}},  //!< 'J':橙(0.5S)→消灯(0.25S)→緑(0.5S)→消灯(0.25S)→赤(0.5S)→消灯(0.25S)→橙(0.5S)→消灯(0.25S)→緑(0.5S)→消灯(0.25S)→赤(0.5S)→消灯(0.25S)
        {{IO_GRN, 1}, {IO_KEP, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'K':常時 緑点灯
        {{IO_RED, 1}, {IO_KEP, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'L':常時 赤点灯
        {{IO_ORG, 1}, {IO_KEP, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'M':常時 橙点灯
        {{IO_ORG, 5}, {IO_OFF, 5}, {IO_TOP, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}, {IO_END, 0}},  //!< 'N':橙0.25秒おき無限点滅(起動時)
        //!< 'Z':何もしない
	...
	TYPE_ERROR LEDOutput(uint8_t LedIndex, ENUM_CTRL Data);
	/*----------------------------
    //LED出力
    -----------------------------*/
	//TYPE_ERROR LEDRGB(uint8_t LedIndex, uint8_t DutyR, uint8_t DutyG, uint8_t DutyB);
    TYPE_ERROR LEDRGB(uint8_t LedIndex, uint8_t DutyR, uint8_t DutyG);
