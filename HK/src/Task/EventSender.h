...
constexpr uint32_t DT_LEN_REQ_READ_2 = 21;                //!< 読取データ データ部長さ
constexpr uint32_t DT_LEN_REQ_READ_24 = 37;                //!< 読取データ データ部長さ
constexpr uint32_t DT_LEN_REQ_RESET = 7;               //!< リセットデータ データ部長さ
