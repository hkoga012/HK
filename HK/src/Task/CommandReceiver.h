...
// 受信パケット データ部の長さ 定義
constexpr uint32_t DT_LEN_INST_CMD = 6;                 //!< 指示コマンド データ部長さ
...
constexpr uint32_t LEN_LED_IN_INST_CMD = 3;             //!< LED点灯指示 データ長
constexpr uint32_t POS_BUZZER_IN_INST_CMD = 5;          //!< ブザー鳴動指示 指示コマンド内のデータ位置
constexpr uint32_t LEN_BUZZER_IN_INST_CMD = 1;          //!< ブザー鳴動指示 データ長
constexpr uint32_t POS_AUTODOOR_IN_INST_CMD = 4;        //!< 自動扉出力指示 指示コマンド内のデータ位置
