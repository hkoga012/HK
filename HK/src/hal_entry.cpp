...
PWM *G_pDrvPWM_LED_1_G;      //PWM
PWM *G_pDrvPWM_LED_2_G;    //PWM
PWM *G_pDrvPWM_LED_3_G;     //PWM
PWM *G_pDrvPWM_LED_P_G;     //PWM
...
TYPE_ERROR Init(void)
{
    ...
    */
    ...
    err = G_pDrvPWM_LED_1_G->Init();
    if(E_OK != err){goto Init_Error;}
     err = G_pDrvPWM_LED_2_G->Init();
    if(E_OK != err){goto Init_Error;}
     err = G_pDrvPWM_LED_3_G->Init();
    if(E_OK != err){goto Init_Error;}
     err = G_pDrvPWM_LED_P_G->Init();
    if(E_OK != err){goto Init_Error;}
...
void CreateDeviceDriver(void)
{
    ...
    */
    G_pDrvPWM_LED_1_G = new PWM(&g_timer1_ctrl, &g_timer1_cfg);
    G_pDrvPWM_LED_2_G = new PWM(&g_timer8_ctrl, &g_timer8_cfg);
    G_pDrvPWM_LED_3_G = new PWM(&g_timer1_ctrl, &g_timer1_cfg);
    G_pDrvPWM_LED_P_G = new PWM(&g_timer5_ctrl, &g_timer5_cfg);
